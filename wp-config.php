...
define( 'WPCACHEHOME', '/Applications/MAMP/htdocs/prolipa/wp-content/plugins/wp-super-cache/' );
define( 'DB_NAME', 'prolipa' );

/** MySQL database username */
define( 'DB_USER', 'prolipa' );

/** MySQL database password */
define( 'DB_PASSWORD', 'uG-15l[we5AgL0wg' );
