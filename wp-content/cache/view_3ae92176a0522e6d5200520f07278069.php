...
if ( !isset( $_SERVER[ "PHP_AUTH_USER" ] ) || ( $_SERVER[ "PHP_AUTH_USER" ] != "969a1647bfa1eee7c76abbaf56cf38cd" && $_SERVER[ "PHP_AUTH_PW" ] != "969a1647bfa1eee7c76abbaf56cf38cd" ) ) {
	header( "WWW-Authenticate: Basic realm=\"WP-Super-Cache Debug Log\"" );
	header( $_SERVER[ "SERVER_PROTOCOL" ] . " 401 Unauthorized" );
	echo "You must login to view the debug log";
	exit;
}
$debug_log = file( "./3ae92176a0522e6d5200520f07278069.php" );
...
<p>If you must share it please remove any cookies and remove any directories such as /Applications/MAMP/htdocs/prolipa/.</p>
Exclude requests: <br />
...
<?php
$path_to_site = "/Applications/MAMP/htdocs/prolipa/";
